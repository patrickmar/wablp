...
// // ✅ import API helpers
// import { fetchNews, fetchStats } from "@/utils/api";
...
//   // ✅ Load stats (mock on Netlify, real in dev)
//   useEffect(() => {
//     fetchStats()
...
//   // ✅ Load news (mock on Netlify, real in dev)
//   useEffect(() => {
//     fetchNews()
...
export function DashboardPage() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/routes/stats")
      .then((res) => res.json())
      .then((data) => setStats(data))
      .catch((err) => console.error("Failed to load stats:", err))
      .finally(() => setLoading(false));
  ...
  useEffect(() => {
    fetch("http://localhost:5000/routes/news")
      .then((res) => res.json())
      .then((data) => setNews(data))
      .catch((err) => console.error("Failed to load news:", err));
  }, []);
