...
//               <span className="text-[#C9A74B] font-medium">560+ Verified Businesses Connected</span>
//             </div>
...
//                 size="lg"
//                 variant="outline"
//                 className="border-2 border-white text-white hover:bg-white hover:text-[#005A8C] px-8 py-4 text-lg font-semibold transform hover:scale-105 transition-all duration-200"
//               >
