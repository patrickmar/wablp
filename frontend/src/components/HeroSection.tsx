            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Link href="/videos/demo.mp4" target="_blank">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-[#005A8C] hover:bg-white hover:text-[#005A8C] px-8 py-4 text-lg font-semibold transform hover:scale-105 transition-all duration-200 flex items-center"
                >
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex space-x-2">
                  {Array.from({ length: instanceRef.current.track.details.slides.length }).map((_, idx) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full ${currentSlide === idx ? "bg-[#C9A74B]" : "bg-white/50 hover:bg-white"
                        }`}
