...
type CataloguePageProps = {
  ...
  businessId?: string; // ✅ added for filtering by seller
};

export function CataloguePage({ onSelectProduct, onCreateCatalogue, businessId }: CataloguePageProps) {
  ...
  const handleSearch = () => {
    ...
    // ✅ filter by seller if businessId provided
    if (businessId) filters.seller = businessId;
